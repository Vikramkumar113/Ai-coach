...
CREATE TABLE "Asseessment" (
    ...
    CONSTRAINT "Asseessment_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Asseessment_userId_idx" ON "Asseessment"("userId");
...
-- AddForeignKey
ALTER TABLE "Asseessment" ADD CONSTRAINT "Asseessment_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
